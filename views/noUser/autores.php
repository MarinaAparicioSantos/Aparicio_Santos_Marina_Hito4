                         ...
                         <div class="card-body">
                             ...
                             <div class="row g-3 align-items-center">
                                 ...
                                 <div class="col-7 col-sm-7 col-md-7">
                                     <h5 class="titulo mt-3"><?php echo $autor['nombreArtistico'] ?></h5>
                                     <h5 class="rebajas mt-3"><?php echo $autor['redSocial'] ?></h5>
                                     <a class="btn btn-primary mt-5" href=<?php echo 'index.php?controller=obras&action=perfilAutor&id=' . $idAutor ?> role="button">Detalles</a>
                                 </div>
                             </div>
